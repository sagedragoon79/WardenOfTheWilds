...
[assembly: MelonInfo(typeof(WardenOfTheWilds.WardenOfTheWildsMod), "Warden of the Wilds", "1.0.16", "SageDragoon")]
...
namespace WardenOfTheWilds
{
    public class WardenOfTheWildsMod : MelonMod
    {
        ...
        public override void OnInitializeMelon()
        {
            ...
            // v1.0.16 — Event-driven enhancement attach. Replaces the
            ...
            // v1.0.16 — DLC patches. Soft-fail when types are missing
            ...
            Log.Msg($"[WotW] Warden of the Wilds 1.0.16 loaded." +
        ...
        public override void OnSceneWasLoaded(int buildIndex, string sceneName)
        {
            ...
            // v1.0.16 — Wild fox population (DLC-gated). System gates itself
            // on DlcDetection.PetsDlcActive, so non-DLC calls are free.
            WildFoxSystem.OnMapLoaded();

            // v1.0.16 — Patch hunter target mask to include fox team so
        ...
        {
            // v1.0.16 fix — switched to realtime polling + 5-min cap.
            //
            ...
            // v1.0.16 fix #2 — wait for the spawn-interval DICT to be
            ...
            //
            // v1.0.16 fix #3 — don't burn the retry budget while GameManager
        ...
        // ── LateInit: one-shot catch-up sweep (v1.0.16) ────────────────────
        //
        // History:
        ...
        // v1.0.16 — Type resolution cache. Previously TryAttachComponents
        ...
        private bool TryAttachComponents()
        {
            ...
            // assembly without try/catch on every call. v1.0.16 caches
